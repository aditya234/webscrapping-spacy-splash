...
class LondonHotelSpier(scrapy.Spider):
    name = 'london_hotels'
    page_counter = 0

    def start_requests(self):
        url = "https://www.tripadvisor.in/Hotels-g186338-London_England-Hotels.html"
    ...
    def parse(self, response):
        ...
        page_count_str = "-oa" + str(LondonHotelSpier.page_counter) if LondonHotelSpier.page_counter > 0 else ''
        LondonHotelSpier.page_counter += 30

        next_page = "https://www.tripadvisor.in/Hotels-g186338" + page_count_str + "-London_England-Hotels.html"
    ...
    def parseHotelDetails(self, response):
        ...
        # commenting scraping of reviews because we don't need it as of now
