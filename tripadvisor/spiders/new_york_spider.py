...
class NewYorkHotelSpier(scrapy.Spider):
    name = 'new_york_hotels'
    page_counter = 0
    ...
    def parse(self, response):
        ...
        page_count_str = "-oa" + str(NewYorkHotelSpier.page_counter) if NewYorkHotelSpier.page_counter > 0 else ''
        NewYorkHotelSpier.page_counter += 30

        next_page = "https://www.tripadvisor.in/Hotels-g60763" + page_count_str + "-New_York_City_New_York-Hotels.html"
